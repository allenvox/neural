...
class GradientBoosting:
    ...
    def plot_depth_vs_metrics(self):
        ...
        plt.plot(depths, roc_aucs, marker='o', label="ROC-AUC")
    ...
    def plot_time_vs_depth(self):
        ...
        plt.figure(figsize=(12, 6))
        plt.plot(depths, times, marker='o', label="Training Time")
        plt.xlabel("Max Depth")
    ...
    def plot_tree_training_time(self):
        ...
        plt.figure(figsize=(12, 6))
        plt.plot(range(1, len(self.training_times) + 1), self.training_times, marker='o', label="Time per Tree")
        plt.xlabel("Tree Number")
        plt.ylabel("Training Time (seconds)")
        plt.title("Training Time per Tree")
        plt.legend()
        plt.grid()
        plt.show()
